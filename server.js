...
function remixRealyHints(build) {
  ...
  ...(process.env.NODE_ENV === "development"
    ? [
        (req, res, next) => {
          ...
          remixRealyHints(require(BUILD_DIR))(req, res);
    ...
    : [
        remixRealyHints(require(BUILD_DIR)),
